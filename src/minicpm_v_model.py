...
model = AutoModel.from_pretrained('/Users/matthew/SourceCode/Models/mini_cpm_v_2_6_int4', local_files_only=True, trust_remote_code=True)
tokenizer = AutoTokenizer.from_pretrained('/Users/matthew/SourceCode/Models/mini_cpm_v_2_6_int4', local_files_only=True, trust_remote_code=True)
